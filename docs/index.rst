.. Fourtwenty Alarm Clock documentation master file, created by
   sphinx-quickstart on Sun Sep 13 11:14:18 2015.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to Fourtwenty Alarm Clock's documentation!
================================================

The Fourtwenty Alarm Clock (420AlarmClock for short) is a collection of smart contracts on 
the 420coin blockchain that aims to allow for the scheduling of transactions to be executed 
...
how you can use the 420AlarmClock smart contracts from your own code see :doc:`./quickstart`.
...
.. _github repository: https://github.com/pipermerriam/fourtwenty-alarm-clock
