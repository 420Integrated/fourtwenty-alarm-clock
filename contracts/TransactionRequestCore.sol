...
contract TransactionRequestCore is TransactionRequestInterface {
     ...
     *  uintArgs[8]  - txnData.callSmoke
     *  uintArgs[9]  - txnData.callValue
     *  uintArgs[10] - txnData.smokePrice
    ...
    /*
     *  Allow receiving 420coin.  This is needed if there is a large increase in
     *  network smoke prices.
     */
    ...
    function sendOwnerFourtwentycoin() public returns (bool) {
        return txnRequest.sendOwnerFourtwentycoin();
    }

    function sendOwnerFourtwentycoin(address recipient) public returns (bool) {
        return txnRequest.sendOwnerFourtwentycoin(recipient);
    }
