...
contract BaseScheduler is SchedulerInterface {
    ...
    /*
     * @dev Fallback function to be able to receive 420coin. This can occur
     ...
     * @param _uintArgs [0] The callSmoke of the transaction.
     * @param _uintArgs [1] The value of 420coin to be sent with the transaction.
     ...
     * @param _uintArgs [4] The smokePrice which will be used to execute this transaction.
        ...
        public payable returns (address newRequest)
    {
        ...
        uint endowment = computeEndowment(
            _uintArgs[6], //bounty
            _uintArgs[5], //fee
            _uintArgs[0], //callSmoke
            _uintArgs[1], //callValue
            _uintArgs[4]  //smokePrice
        );
        ...
        if (temporalUnit == RequestScheduleLib.TemporalUnit.Blocks) {
            newRequest = factory.createValidatedRequest.value(msg.value)(
                ...
                [
                    ...
                    _uintArgs[0],               // txnData.callSmoke
                    _uintArgs[1],               // txnData.callValue
                    _uintArgs[4],               // txnData.smokePrice
        ...
        public view returns (uint)
    {
        return PaymentLib.computeEndowment(
            ...
            _callValue,
            _smokePrice,
            RequestLib.getEXECUTION_SMOKE_OVERHEAD()
        );
    }
}
