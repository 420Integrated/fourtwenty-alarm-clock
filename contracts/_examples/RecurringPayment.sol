...
contract RecurringPayment {
        ...
        private returns (bool)
    {
        ...
        currentScheduledTransaction = scheduler.schedule.value(0.1 420coin)( // 0.1 420coin is to pay for smoke, bounty and fee
            this,                   // send to self
            "",                     // and trigger fallback function
            [
                1000000,            // The amount of smoke to be sent with the transaction. Accounts for payout + new contract deployment
                0,                  // The amount of marley to be sent.
                255,                // The size of the execution window.
                lockedUntil,        // The start of the execution window.
                20000000000 marley,    // The smokeprice for the transaction (aka 20 gmarley)
                20000000000 marley,    // The fee included in the transaction.
                20000000000 marley,    // The bounty that awards the executor of the transaction.
                30000000000 marley     // The required amount of marley the claimer must send as deposit.
            ]
        );
